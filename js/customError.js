export const tiposError = [
    "valueMissing", //Nos avisa cuando el campo está vacio
    "typeMissmatch", //Nos aviso que ingrese el tipo de dato esperado
    "patternMissmatch", //Nos avisa como es el formato/patrón del cuil
    "tooShort", //Nos avisa que el campo contiene los caracteres inecesarios 
    "customError", //Nos muestra un error, un mensaje personalizado del error
];
